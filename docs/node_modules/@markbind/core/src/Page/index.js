...
const htmlValidationUtil_1 = require("../utils/htmlValidationUtil");
...
class Page {
    ...
    generate(externalManager) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, htmlValidationUtil_1.checkForVueHydrationViolation)(content, this.pageConfig.sourcePath);
            // Compile the page into Vue application and outputs the render function into script for browser
            const renderFn = yield PageVueServerRenderer_1.pageVueServerRenderer.compileVuePageCreateAndReturnScript(content, this.pageConfig, this.asset);
            PageVueServerRenderer_1.pageVueServerRenderer.savePageRenderFnForHotReload(this, pageNav, renderFn);
             ...
             */
            const vueSsrHtml = yield PageVueServerRenderer_1.pageVueServerRenderer.renderVuePage(renderFn);

        ...
        try {
            ...
            switch (node.name) {
                ...
                case 'include':
                    ...
                    return (0, includePanelProcessor_1.processInclude)(node, context, this.pageSources, this.variableProcessor, (text) => this.markdownProcessor.renderMd(text), (text) => this.markdownProcessor.renderMdInline(text), this.config, this.siteLinkManager);
                case 'panel':

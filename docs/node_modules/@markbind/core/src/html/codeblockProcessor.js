 ...
 */
function traverseLinePart(node, hlStart, hlEnd, color) {
    const resData = {
        numCharsTraversed: 0,
    ...
    node.children.forEach((child, idx) => {
        ...
        if (!data.highlightRange) {
            if (color) {
                (0, cheerio_1.default)(child).wrap(`<span style='background-color: ${color};'></span>`);
            }

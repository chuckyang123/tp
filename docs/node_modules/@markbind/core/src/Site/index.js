...
class Site {
    ...
    createPage(config) {
        ...
        const pageConfig = new PageConfig_1.PageConfig({
            asset: {
                ...
                bootstrapIcons: path_1.default.posix.join(baseAssetsPath, 'bootstrap-icons', 'font', 'bootstrap-icons.css'),
                ...
                vue: this.dev
                    ...
                    : path_1.default.posix.join(baseAssetsPath, 'js', 'vue.global.prod.min.js'),
    ...
    generate(baseUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.copyBootstrapIconsAsset();
    ...
    copyBootstrapIconsAsset() {
        ...
        const bootstrapIconsFontsSrcPath = path_1.default.dirname(bootstrapIconsCssSrcPath);
        const bootstrapIconsFontsDestPath = path_1.default.join(this.siteAssetsDestPath, 'bootstrap-icons', 'font');
        return fs_extra_1.default.copy(bootstrapIconsFontsSrcPath, bootstrapIconsFontsDestPath);
    }
    /**
    ...
    getDepOptions(ciTokenVar, defaultDeployConfig, publish) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!process.env.CACHE_DIR || ['true', 'false', '1', '0'].includes(process.env.CACHE_DIR)) {
                const cacheDirectory = path_1.default.join(this.rootPath, 'node_modules', '.cache');
                fs_extra_1.default.emptydirSync(path_1.default.join(cacheDirectory, 'gh-pages'));
            ...
            if (ciTokenVar) {
                ...
                if (process.env.TRAVIS) {
                    ...
                    process.env.CACHE_DIR = path_1.default.join(process.env.GITHUB_WORKSPACE || '.cache');
